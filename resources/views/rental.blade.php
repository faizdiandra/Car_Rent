...
<tr>
    ...
    <td><img witdh = "40px" src ="{{asset('images/'.$data->fotomobil)}}"></td>
    <td><a href = "/peminjaman_create" class = "btn btn-success btn-sm">Pinjam</a>
	<a href = "/mobil/show/{{ $data->id_mobil }}" class = "btn btn-primary btn-sm">Detail</a></td>
</tr>
